...
$html = new person_html;
$html->draw_header('List View: person', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add person')) echo "&nbsp; &nbsp; <a href='add_person.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new person</a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;        
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_person.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&person_id=$person_id'><img src='../images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit person')) echo "&nbsp;&nbsp;<a href='edit_person.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&person_id=$person_id'><img src='../images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete person')) echo "&nbsp;&nbsp;<a href='delete_person.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&person_id=$person_id'><img src='../images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
