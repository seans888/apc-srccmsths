...
$html = new user_html;
$html->draw_header('List View: user', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add user')) echo "&nbsp; &nbsp; <a href='add_user.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new user</a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;        
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_user.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&username=$username'><img src='../images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit user')) echo "&nbsp;&nbsp;<a href='edit_user.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&username=$username'><img src='../images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete user')) echo "&nbsp;&nbsp;<a href='delete_user.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&username=$username'><img src='../images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
