...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_requirement_' . $timestamp . '.csv';
...
$html->draw_text_field('Type', 'type', FALSE, 'text', TRUE);
$html->draw_text_field('Year', 'year', FALSE, 'text', TRUE);
$html->draw_text_field('Document', 'document', FALSE, 'text', TRUE);
