...
$html = new user_role_html;
$html->draw_header('List View: user role', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add user role')) echo "&nbsp; &nbsp; <a href='add_user_role.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new user role</a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;        
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_user_role.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&role_id=$role_id'><img src='../images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit user role')) echo "&nbsp;&nbsp;<a href='edit_user_role.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&role_id=$role_id'><img src='../images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete user role')) echo "&nbsp;&nbsp;<a href='delete_user_role.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&role_id=$role_id'><img src='../images/delete.png' alt='Delete' title='Delete'></a>";
            if(check_link('Add user role'))  echo "&nbsp;&nbsp;<a class='listview' href='role_permissions.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&role_id=$role_id'>[Role Permissions]</a>";
            echo '</td>';
