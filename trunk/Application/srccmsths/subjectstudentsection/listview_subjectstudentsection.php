...
$data_con = new subjectstudentsection;
...
$html = new subjectstudentsection_html;
$html->draw_header('List View: subjectstudentsection', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add subjectstudentsection')) echo "&nbsp; &nbsp; <a href='add_subjectstudentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View subjectstudentsection')) echo "&nbsp; &nbsp; <a href='csv_subjectstudentsection.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_subjectstudentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Subject_subject_no=$Subject_subject_no&StudentSection_Student_student_no=$StudentSection_Student_student_no&StudentSection_Section_section_no=$StudentSection_Section_section_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit subjectstudentsection')) echo "&nbsp;&nbsp;<a href='edit_subjectstudentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Subject_subject_no=$Subject_subject_no&StudentSection_Student_student_no=$StudentSection_Student_student_no&StudentSection_Section_section_no=$StudentSection_Section_section_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete subjectstudentsection')) echo "&nbsp;&nbsp;<a href='delete_subjectstudentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Subject_subject_no=$Subject_subject_no&StudentSection_Student_student_no=$StudentSection_Student_student_no&StudentSection_Section_section_no=$StudentSection_Section_section_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
