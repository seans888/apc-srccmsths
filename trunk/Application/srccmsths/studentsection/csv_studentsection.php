...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_studentsection_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_studentsection->export_to_csv();
...
$html->draw_header('CSV Exporter: studentsection', $message, $message_type);
...
$html->draw_text_field('Student Student No', 'Student_student_no', FALSE, 'text', TRUE);
$html->draw_text_field('Section Section No', 'Section_section_no', FALSE, 'text', TRUE);
