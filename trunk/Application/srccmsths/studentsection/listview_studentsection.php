...
$html = new studentsection_html;
$html->draw_header('List View: studentsection', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add studentsection')) echo "&nbsp; &nbsp; <a href='add_studentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View studentsection')) echo "&nbsp; &nbsp; <a href='csv_studentsection.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_studentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Student_student_no=$Student_student_no&Section_section_no=$Section_section_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit studentsection')) echo "&nbsp;&nbsp;<a href='edit_studentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Student_student_no=$Student_student_no&Section_section_no=$Section_section_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete studentsection')) echo "&nbsp;&nbsp;<a href='delete_studentsection.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Student_student_no=$Student_student_no&Section_section_no=$Section_section_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
