...
$html = new exam_html;
$html->draw_header('List View: exam', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add exam')) echo "&nbsp; &nbsp; <a href='add_exam.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View exam')) echo "&nbsp; &nbsp; <a href='csv_exam.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_exam.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&exam_no=$exam_no&Applicant_applicant_no=$Applicant_applicant_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit exam')) echo "&nbsp;&nbsp;<a href='edit_exam.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&exam_no=$exam_no&Applicant_applicant_no=$Applicant_applicant_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete exam')) echo "&nbsp;&nbsp;<a href='delete_exam.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&exam_no=$exam_no&Applicant_applicant_no=$Applicant_applicant_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
