...
$html = new department_html;
$html->draw_header('List View: department', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add department')) echo "&nbsp; &nbsp; <a href='add_department.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View department')) echo "&nbsp; &nbsp; <a href='csv_department.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_department.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&dept_no=$dept_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit department')) echo "&nbsp;&nbsp;<a href='edit_department.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&dept_no=$dept_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete department')) echo "&nbsp;&nbsp;<a href='delete_department.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&dept_no=$dept_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
