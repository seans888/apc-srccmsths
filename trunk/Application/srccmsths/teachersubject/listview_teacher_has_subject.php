...
init_cobalt('View teacher has subject');
...
$data_con = new teacher_has_subject;
...
$html = new teacher_has_subject_html;
$html->draw_header('List View: teacher has subject', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add teacher has subject')) echo "&nbsp; &nbsp; <a href='add_teacher_has_subject.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View teacher has subject')) echo "&nbsp; &nbsp; <a href='csv_teacher_has_subject.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_teacher_has_subject.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no&Subject_subject_no=$Subject_subject_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit teacher has subject')) echo "&nbsp;&nbsp;<a href='edit_teacher_has_subject.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no&Subject_subject_no=$Subject_subject_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete teacher has subject')) echo "&nbsp;&nbsp;<a href='delete_teacher_has_subject.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no&Subject_subject_no=$Subject_subject_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
