...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_interviewee_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_interviewee->export_to_csv();
...
$html->draw_header('CSV Exporter: interviewee', $message, $message_type);
...
$html->draw_text_field('Status', 'status', FALSE, 'text', TRUE);
$html->draw_text_field('Date', 'date', FALSE, 'text', TRUE);
$html->draw_text_field('Exam Exam No', 'Exam_exam_no', FALSE, 'text', TRUE);
$html->draw_text_field('Exam Applicant Applicant No', 'Exam_Applicant_applicant_no', FALSE, 'text', TRUE);
