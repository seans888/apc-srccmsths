...
$html = new interviewee_html;
$html->draw_header('List View: interviewee', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add interviewee')) echo "&nbsp; &nbsp; <a href='add_interviewee.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View interviewee')) echo "&nbsp; &nbsp; <a href='csv_interviewee.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_interviewee.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&interview_no=$interview_no&Exam_exam_no=$Exam_exam_no&Exam_Applicant_applicant_no=$Exam_Applicant_applicant_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit interviewee')) echo "&nbsp;&nbsp;<a href='edit_interviewee.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&interview_no=$interview_no&Exam_exam_no=$Exam_exam_no&Exam_Applicant_applicant_no=$Exam_Applicant_applicant_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete interviewee')) echo "&nbsp;&nbsp;<a href='delete_interviewee.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&interview_no=$interview_no&Exam_exam_no=$Exam_exam_no&Exam_Applicant_applicant_no=$Exam_Applicant_applicant_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
