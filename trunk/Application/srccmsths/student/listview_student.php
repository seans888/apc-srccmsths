...
$html = new student_html;
$html->draw_header('List View: student', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add student')) echo "&nbsp; &nbsp; <a href='add_student.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View student')) echo "&nbsp; &nbsp; <a href='csv_student.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_student.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&student_no=$student_no&Interviewee_interview_no=$Interviewee_interview_no&Interviewee_Exam_exam_no=$Interviewee_Exam_exam_no&Interviewee_Exam_Applicant_applicant_no=$Interviewee_Exam_Applicant_applicant_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit student')) echo "&nbsp;&nbsp;<a href='edit_student.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&student_no=$student_no&Interviewee_interview_no=$Interviewee_interview_no&Interviewee_Exam_exam_no=$Interviewee_Exam_exam_no&Interviewee_Exam_Applicant_applicant_no=$Interviewee_Exam_Applicant_applicant_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete student')) echo "&nbsp;&nbsp;<a href='delete_student.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&student_no=$student_no&Interviewee_interview_no=$Interviewee_interview_no&Interviewee_Exam_exam_no=$Interviewee_Exam_exam_no&Interviewee_Exam_Applicant_applicant_no=$Interviewee_Exam_Applicant_applicant_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
