...
$html = new section_html;
$html->draw_header('List View: section', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add section')) echo "&nbsp; &nbsp; <a href='add_section.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View section')) echo "&nbsp; &nbsp; <a href='csv_section.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_section.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&section_no=$section_no&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no'><img src='/srccmsths/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit section')) echo "&nbsp;&nbsp;<a href='edit_section.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&section_no=$section_no&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no'><img src='/srccmsths/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete section')) echo "&nbsp;&nbsp;<a href='delete_section.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&section_no=$section_no&Teacher_teacher_no=$Teacher_teacher_no&Teacher_Department_dept_no=$Teacher_Department_dept_no'><img src='/srccmsths/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
